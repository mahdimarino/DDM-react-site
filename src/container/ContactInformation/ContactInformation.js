        ...
        <div className={`section section-padding-t90-b100 ${classOption}`}>
            <div className="container shape-animate">
                <SectionTitle
                    ...
                    subTitle="Distinct Digital Media, a trusted marketing partner, was founded to build meaningful client relationships. With a decade of experience, we drive impactful campaigns using actionable data to boost your products effectively."
                />
